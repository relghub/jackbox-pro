    ...
    <div class="form-group">\r
        <div class="inputGroup">\r
            ...
            <span class="inlineSubmit">\r
                <button type="submit" class="btn btn-default inlineSubmitButton" type="button"><span class="inlineSubmitText">ВІДПРАВИТИ</span></button>\r
            </span>\r
    ...
    LC = Et.View.extend({
        ...
        bindings: {
            ...
            ".submitDrawing": {
                ...
                updateView: !0,
                onGet(t) {
                    return t[0] || t[1] ? !1 : t[2] === void 0 ? "" : t[2].submit || "ВІДПРАВИТИ"
                }
            }
        },
        initialize() {
...
const lc = Et.View.extend({
    ...
    <div id="artifactId" class="artifactContainer text">
        <a id="artifactLink" aria-label="Відвідати галерею" class="artifactLink" target="_blank">
            ...
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                if (i === "changeName") try {
                        const a = await Ot.show("custom", {
                            ...
                            inputValidator: f => f ? f.length > 12 ? "Обмеження 12 символів" : null : "Тобі треба хоч щось написати!"
                        });
                        if (a.dismiss) return;
                        this.triggerMethod("client:message", {
                            name: a.value
                ...
                <div id="lobby-main-menu">\r
                    <div class="fakinit-change-name-dialog">\r
                        <form class="fakinit-name-change-form" style="display:none;">\r
                            <div class="form-group">\r
                                <input type="input" class="form-control fakinit-input" id="fakinitNameChange" placeholder="ім'я" maxLength=12>\r
                            </div>\r
                            <div class="row">\r
                                <div class="col-xs-12">\r
                                    <button id="fakinit-name-change-confirm" type="submit" class="fakinit-button fakinit-button-secondary pull-right">НАДІСЛАТИ</button>\r
                                    <button id="fakinit-name-change-cancel" class="fakinit-button fakinit-button-secondary pull-right">Скасувати</button>\r
                                </div>\r
                            </div>\r
                        </form>\r
                        <p class="fakinit-name-change-button"><button id="fakinit-name-change" class="fakinit-button fakinit-button-secondary">Змінити ім'я?</button></p>\r
                        <p><span class="fakinit-text fakinit-text-instruction fakinit-category-color">Використовуй своє справжнє ім'я, щоб тебе було легко відрізняти від інших</span></p>\r
                    </div>\r
                    <form class="pure-form">\r
                        <button type="button" id="fakinit-startgame" class="fakinit-button btn btn-lg btn-block">УСІ ТУТ</button>\r
                        <button type="button" id="fakinit-stopcountdown" class="fakinit-button btn btn-lg btn-block">СКАСУВАТИ</button>\r
                        ...
                        <button type="button" id="fakinit-sameplayers" class="fakinit-button btn btn-lg btn-block fakinit-endbuttons">ТИМ ЖЕ СКЛАДОМ</button>\r
                        <button type="button" id="fakinit-newplayers" class="fakinit-button btn btn-lg btn-block fakinit-endbuttons">НОВІ ГРАВЦІ</button>   \r
                    </form>\r
\r
                    <div class="pure-u-1"></div>\r
                    \r
                    <form class="pure-form">\r
                        <button type="button" id="fakinit-lobby-menu-censor" class="menu-button lobby-button fakinit-button button-xlarge pure-button pure-input-1">Меню цензури</button><br>\r
                    </form>\r
                </div>\r
            </div>\r
        </div>\r
        ...
        <div class="state-gameplay pt-page-off fakinit-page fakinit-category-background">\r
            <div>\r
                ...
                <div class='container fakinit-gameplay-sign fakinit-gameplay-ready'>\r
                    <p class="fakinit-text"><span id="press-instruction" class="fakinit-text-instruction">Як будеш готовий, натисни кнопку</span></p>\r
                    <button class='fakinit-ready-button fakinit-button btn btn-lg btn-block button-send'>ГОТОВИЙ</button>\r
                </div>\r
                \r
                    ...
                    <div class="container">\r
                        <form class="form-inline">\r
                            <div class="form-group" id="fakinit-input-text">\r
                                <input id='enteredText' value='' type='text' class='form-control fakinit-input input-lg' autocapitalize='off' autocorrect='off' autocomplete='off' maxlength='45' placeholder='пиши тут'/>\r
                                <span id="fakinit-submit-alert" class="help-block fakinit-text fakinit-text-instruction" style="color:white;"></span>\r
                            </div>\r
                            <button id="input-send" type="submit" class='fakinit-button btn button-input'>ВІДПРАВИТИ</button>\r
                        </form>\r
                    </div>\r
                </div>\r
\r
...
\r
        <div class="state-skip-instructions pt-page-off fakinit-page">\r
            <!-- <div style="height:100%;display:flex;flex-direction:column;"> -->\r
                <p><button class='fakinit-skip-button fakinit-button fakinit-button-secondary button-send'>ПРОПУСТИТИ</button></p>\r
                <div class="fakinit-text fakinit-category-color">\r
                    <p class="fakinit-text-instruction ">Натисни ПРОПУСТИТИ, якщо всі знають, як грати</p>\r
                </div>\r
...
\r
        <div class="state-categories pt-page-off fakinit-page">\r
            <div id="fakinit-instruction-box-categories" class="fakinit-instruction-box">\r
                <p id="category-title" class="fakinit-title fakinit-category-color">ВИБРАТИ КАТЕГОРІЮ</p>\r
...
\r
        <div class="pt-page-off state-vote fakinit-page fakinit-category-background">\r
            ...
            <div id="fakinit-bar-vote" class="fakinit-bar fakinit-category-background-dark">\r
                <span id="fakinit-title-vote" class="fakinit-title fakinit-text-instruction">Хто ж Симулянт?</span>\r
            </div>\r
            <div class="container">\r
                <div class="">\r
                    ...
                    <p id="fakinit-vote-lock" class="fakinit-vote-lock"><span id="vote-lock-instruction" class="fakinit-text fakinit-text-instruction">ЗАФІКСУВАТИ ВІДПОВІДЬ</span></p>\r
                </div>\r
            </div>\r
        </div>\r
\r
        <div class="pt-page-off state-vote-locked fakinit-page fakinit-category-background">\r
            ...
            <div id="fakinit-bar-vote-locked" class="fakinit-bar fakinit-category-background-dark">\r
                <span id="fakinit-title-vote-locked" class="fakinit-title fakinit-text-instruction">Хто ж Симулянт?</span>\r
            </div>\r
            <div class="container">\r
                <div>\r
                    ...
                    <p class="fakinit-text"><span id="vote-locked-instruction" class="fakinit-text fakinit-text-instruction">Відповідь зафіксовано!</span></p>\r
                    <p class="fakinit-text"><span id="vote-locked-waiting"class="fakinit-text fakinit-text-instruction">Почекай на інших гравців!</span></p>\r
                </div>\r
            </div>\r
        </div>\r
    </div>\r
...
const zx = lc.extend({
    ...
    prevPlayerState: "",
    doneAnswering: !1,
    categoryFlavor: ["це весело", "ми віримо у вас", "це легко", "не змушуйте всіх чекати", "це найпростіша частина", "ну будь ласка!", "це важливо", "ти можеш це зробити", "зроби це", "у тебе є сила", "вибирайте з розумом", "настав твій час блищати", "твоя черга", "це твій обов'язок"],
    events: {
    ...
    updatePlayer() {
        ...
        if (i && i === "Lobby") {
            ...
            if (f !== "PostGame" && f !== "PostGameCountdown" && le(".fakinit-change-name-dialog").show(), !t.isAllowedToStartGame) {
                le("#fakinit-lobby-text").html("Відкинься на спинку і відпочинь!"), this.showScreen(".state-lobby");
                return
            }
            f === "WaitingForMore" ? le("#fakinit-lobby-text").html("Очікуємо інших гравців") : f === "CanStart" ? (le("#fakinit-lobby-text").html("Нажми цю кнопку, коли всі приєдналися"), le("#fakinit-startgame").show()) : f === "Countdown" || f === "PostGameCountdown" ? (le("#fakinit-lobby-text").html("Натисни цю кнопку, щоб відмінити запуск гри"), le("#fakinit-stopcountdown").show()) : f === "PostGame" ? (le("#fakinit-lobby-text").html("Що ти хочеш робити?"), le(".fakinit-endbuttons").show()) : le("#fakinit-lobby-text").html("<br />Сідайте зручніше!<br>Очікуємо, коли VIP почне гру")
    ...
    updateAudience() {
        const t = this.model.get("room"),
            e = t ? t.state : "";
        switch (t.state === "Gameplay_Input" && (t.category = "Пиши-не-спиши"), this.setCategory(t.category), e) {
            case "Lobby":
                this.hideLobbyButtons(), le("#fakinit-lobby-text").html("Sit tight!<br>Очікуємо, поки VIP почне гру!"), this.showScreen(".state-lobby");
                break;
            case "Gameplay_Logo":
            case "Ready":
            case "Instructions":
            ...
            case "Gameplay_CategorySelection":
                le("#notchoosing").html(`${t.choosingPlayerName} обирає категорію`), this.showScreen(".state-notchoosing");
                break;
            case "Gameplay":
            case "Gameplay_Go":
            case "Gameplay_Stop":
                ...
                break;
            case "Gameplay_Input":
                t.category = "Пиши-не-спиши", le(".fakinit-category").html(t.category), le(".fakinit-task").html("Сядьте струнко!<br>Гравці відповідають"), le(".fakinit-gameplay-sign").hide(), this.showScreen(".state-gameplay");
                break;
            case "Vote": {
    ...
    setCategory(t) {
        if (le(".fakinit-category-background").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), le(".fakinit-category-background-dark").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), le(".fakinit-category-color").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), t) {
            ...
            const e = t.replace(/\s/g, "").toLowerCase().replace("рукивгору", "handsoftruth").replace("лицекомпанії", "facevalue").replace("методтику", "yougottapoint").replace("cкількидаси", "numberpressure").replace("пиши-не-спиши", "textyouup");
    ...
    sendInput() {
        ...
        return e.hide(), t.length === 0 ? (e.html("Неможливо ввести порожнечу!"), e.show(), !1) : (this.client.send("SendMessageToRoomOwner", {
            answer: !0,
            msg: t
        }), !1)
    },
    ...
    sanitizeInput(t) {
        return t = t.replace(/[^\u00A1\u0020-\u0022\u0024-\u0029\u002B-\u002F\u003A-\u007E\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458\u0490\u0491\u0404\u0454\u2018-\u2019\u2026!?*$+\-’'_ .,=<>:;]/gi, ""), t
    },
    validateInput(t) {
        const e = le(t.target);
        let n = e.val();
